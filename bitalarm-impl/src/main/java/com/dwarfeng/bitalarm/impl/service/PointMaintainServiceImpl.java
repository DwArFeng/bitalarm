...
public class PointMaintainServiceImpl implements PointMaintainService {
    ...
    private final CustomBatchCrudService<LongIdKey, Point> crudService;
    private final DaoOnlyEntireLookupService<Point> entireLookupService;
    private final DaoOnlyPresetLookupService<Point> presetLookupService;

    public PointMaintainServiceImpl(
            CustomBatchCrudService<LongIdKey, Point> crudService,
            DaoOnlyEntireLookupService<Point> entireLookupService,
            DaoOnlyPresetLookupService<Point> presetLookupService
    ) {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<Point> batchGet(@SkipRecord List<LongIdKey> keys) throws ServiceException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public List<LongIdKey> batchInsert(@SkipRecord List<Point> elements) throws ServiceException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchUpdate(@SkipRecord List<Point> elements) throws ServiceException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<Point> batchGetIfExists(@SkipRecord List<LongIdKey> keys) throws ServiceException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public List<LongIdKey> batchInsertIfExists(@SkipRecord List<Point> elements) throws ServiceException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public List<LongIdKey> batchInsertIfNotExists(@SkipRecord List<Point> elements) throws ServiceException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchUpdateIfExists(@SkipRecord List<Point> elements) throws ServiceException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public List<LongIdKey> batchInsertOrUpdate(@SkipRecord List<Point> elements) throws ServiceException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public Point lookupFirst() throws ServiceException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<Point> lookupAsList(String preset, Object[] objs, PagingInfo pagingInfo) throws
            ServiceException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public Point lookupFirst(String preset, Object[] objs) throws ServiceException {
